...
3. Pick the source style (X, Threads, or Substack) so the image looks authentic.
4. Choose a canvas size — Square for the feed, Portrait for reach, Story for Stories.
5. Export a high-resolution PNG.
